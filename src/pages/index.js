...
<section id="interests" className="mt-8">
    ...
    <img src="./images/33.jpg" alt="Hunza Valley, Northern Areas Pakistan" width="650" height="900" />
    <div className="text-gray-800 mt-2 dark:text-white">Hunza Valley, Northern Areas Pakistan</div>
  </div>

  <div className="image2">
    <img src="./images/00.jpg" alt="Gooseberry Falls State Park, Minnesota, USA" width="800" height="600" />
    <div className="text-gray-800 mt-2 dark:text-white">Gooseberry Falls State Park, Minnesota, USA</div>
  </div>

  <div className="image3">
    <img src="./images/44.jpg" alt="Mukhspuri Peak, Northern Areas Pakistan" width="550" height="750"  />
